    ...
    try {
        ...
        const dataDetail = req.body.data.map((value, index) => {
            return {
                ...
                pasien_wanita_keluar_mati_kurang_dari_48_jam: value.pasienKeluarMatiKurangDari48Jam,
                pasien_wanita_keluar_mati_lebih_dari_atau_sama_dengan_48_jam: value.pasienKeluarMatiLebihDariAtauSamaDengan48Jam,
